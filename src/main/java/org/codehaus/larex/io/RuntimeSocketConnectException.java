...
public class RuntimeSocketConnectException extends RuntimeIOException
{
    ...
    public RuntimeSocketConnectException(String message)
    {
        super(message);
    }

    public RuntimeSocketConnectException(String message, Throwable cause)
    {
        super(message, cause);
    }

    public RuntimeSocketConnectException(Throwable cause)
    {
        super(cause);
    }
}
