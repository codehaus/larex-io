...
public class SSLEndpoint<C extends Connection> extends StandardEndpoint<C>
{
    ...
    public SSLEndpoint(ConnectionFactory<C> connectionFactory, Reactor reactor, ByteBuffers byteBuffers, Executor threadPool, SSLContext sslContext, ByteBuffers sslByteBuffers)
    {
        super(connectionFactory, reactor, byteBuffers, threadPool);
